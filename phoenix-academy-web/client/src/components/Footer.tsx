    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Phoenix 05 Academy</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Developing young football talent with professional coaching, 
              modern facilities, and a commitment to excellence both on and off the pitch.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              <p>📍 Phoenix Academy Training Ground</p>
              <p>📞 +1 (555) 123-4567</p>
              <p>✉️ info@phoenix05academy.com</p>
              <p>🕒 Mon-Fri: 9AM-6PM</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-300">
          <p>
            &copy; {new Date().getFullYear()} Phoenix 05 Football Academy. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
